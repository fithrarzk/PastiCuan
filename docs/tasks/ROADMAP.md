...
| CI-002 | Establish required PR gates | Luna | CI-001, CI-002A | autonomous | `unit`, `quality`, `workflow-policy`, `migration`, `container-smoke`, conditional `manifest-validate`, and `security` are green and required |
