...
| CI-001 | review | Luna implementation, root integration | Luna/medium | b9f889e | `fix/CI-001-generated-pr-checks` / `../PastiCuan-wt/ci-001-generated-pr-checks` | `.github/workflows/idx-filings.yml`, `.github/workflows/validate-branch.yml`, `tests/test_workflow_policy.py`, CI-001 task evidence | 2026-08-22 |
